...
const romanianTranslations: Translations = {
  ...
  analytics: {
    ...
    customiseDescription: 'Agenții noștri AI sunt creați pentru a fi ușor de aplicat și configurat. Indiferent de nevoile afacerii tale, ei se integrează perfect și oferă mereu o experiență impresionantă.',
...
const englishTranslations: Translations = {
  ...
  analytics: {
    ...
    customiseDescription: 'Our AI agents are designed to be easy to deploy and configure. No matter your business needs, they integrate seamlessly and always deliver an impressive experience.',
    integrationTitle: 'See Kallina AI in Action',
    integrationDescription: 'Instantly embed, preview, or interact with your favorite tools and dashboards. Seamless integration and real results.',
